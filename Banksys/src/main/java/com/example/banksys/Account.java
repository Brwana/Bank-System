...
public class Account {
    ...
    //    public void transfer(Account account,double amount) throws InsufficientBalance {
//
//            this.withdraw(amount);
//            account.deposit(amount);
//            Transaction t = new Transaction(amount, this.accountID, account.getAccountID());
//            accountTransactions.add(t);
//            account.accountTransactions.add(t);
//    }
